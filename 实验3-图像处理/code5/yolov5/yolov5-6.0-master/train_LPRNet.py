...
from utils.load_lpr_data import CHARS, CHARS_DICT, LPRDataLoader
...
def get_parser():
    ...
    parser.add_argument('--train_img_dirs', default="../datasets/adj_images/train", help='the train images path')
    parser.add_argument('--test_img_dirs', default="../datasets/adj_images/val", help='the test images path')
    ...
    parser.add_argument('--lr_schedule', default=[20, 95, 135, 142, 148], help='schedule for learning rate.')
    parser.add_argument('--save_folder', default='./result-weights/', help='Location to save checkpoint models')
    # parser.add_argument('--pretrained_model', default='./weights/LPRNet-new-pretrain.pth', help='pretrained base model')
...
def train():
    ...
    torch.save(lprnet.state_dict(), args.save_folder + 'LPRNet-new-adj-result.pth')
