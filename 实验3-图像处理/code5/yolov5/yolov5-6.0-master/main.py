...
from utils.load_lpr_data import *
...
def detect(save_img=False):
    ...
    if classify:
        modelc = LPRNet(lpr_max_len=8, phase=False, class_num=len(CHARS), dropout_rate=0)
        ...
        for i, det in enumerate(pred):  # detections per image
                ...
                for de, lic_plat in zip(det, plat_num):
                    ...
                    *xyxy, conf, cls = de
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        result = ""
                        _, _, box, points, plate, brightness, blurriness = p.split("\\")[-1].split('-')
            ...
            if save_img:
                if dataset.mode == 'image':
                    ...
                    # txtfile = save_path + ".txt"
                    txtfile = save_path.replace(".jpg", ".txt")
                    print(txtfile)
                    with open(txtfile, 'a+') as f:
                        f.write(str(recognize_result))
    ...
    print("Accurate: %.3f" % (right_num / total_num))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--det-weights', nargs='+', type=str,
                        default='C:/Code/Licence-Recognition/yolov5-6.0/weights/yolov5_adj_best_4_1.pt',
                        help='model.pt path(s)')
    # parser.add_argument('--rec-weights', nargs='+', type=str, default='./weights/lprnet-new-pretrain.pth', help='model.pt path(s)')
    # parser.add_argument('--rec-weights', nargs='+', type=str, default='./weights/Final_LPRNet_model_train.pth',
    #                     help='model.pt path(s)')
    # parser.add_argument('--rec-weights', nargs='+', type=str, default='./weights/LPRNet-best.pth',
    #                     help='model.pt path(s)')
    parser.add_argument('--rec-weights', nargs='+', type=str,
                        default='C:/Code/Licence-Recognition/yolov5-6.0/weights/LPRNet_new_adj_model_3_194.pth',
                        help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='C:/Code/Licence-Recognition/yolov5-6.0/demo/images/',
                        help='source')  # file/folder, 0 for webcam
    parser.add_argument('--output', type=str, default='C:/Code/Licence-Recognition/yolov5-6.0/demo/rec_result',
